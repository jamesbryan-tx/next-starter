...
const LoginEmail = ({
  ...
  <Html lang='en'>
    <Head></Head>
    <Preview>Sign into {siteName}</Preview>
    <Tailwind>
      <Body className='bg-gray-100 font-sans text-base font-light'>
        <Container>
          ...
          >
            ...
            <p>Click below to sign into your account. Have a nice day!</p>
            <Button
            ...
            <p>
              ...
              If you did not try to sign into your account, you can safely
              ignore this email.
            </p>
          </Section>
          <Section
